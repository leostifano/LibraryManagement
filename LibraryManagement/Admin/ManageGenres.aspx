<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMaster.master" AutoEventWireup="true" CodeBehind="ManageGenres.aspx.cs" Inherits="LibraryManagement.Admin.ManageGenres" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <p>
        Select Author From List:
        <asp:ListBox ID="lstGenres" runat="server"></asp:ListBox>
    </p>
    <p>
